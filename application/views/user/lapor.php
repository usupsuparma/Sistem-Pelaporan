			...
			<div class="col-lg-12">
				<div class="card card-primary card-outline">
					<div class="card-header">
						<h5 class="card-title">SIPMA Polsek Rajagaluh</h5>
					</div>
					<div class="card-body">
						<h6 class="card-title">Informasi</h6>

						<p class="card-text">Selamat datang di Sistem Pengaduan Masyarakat (SIPMA) Polsek Rajagaluh, untuk mengisi aduan klik button dibawah ini.</p>
						<a href="<?= base_url('landing/aduan'); ?>" class="btn btn-primary">Aduan Masyarakat</a>
					</div>
				</div>
			</div>
			<!-- /.col-md-6 -->
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="datatable" class="table table-bordered table-striped nowrap">
							...
							<tbody>
								<?php
								if (!empty($tampil_aduan))
								{
									$no=1;
									foreach ($tampil_aduan as $adu) {
										$nik_p = $adu->nik_p;
										$nama_p = $adu->nama_p;
